...
pub fn bundled_agents() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("research-pipeline-runner", include_str!("../../../agents/research-pipeline-runner/agent.toml")),
        ...
        ("strategist-pipeline-runner", include_str!("../../../agents/strategist-pipeline-runner/agent.toml")),
        ("test-engineer", include_str!("../../../agents/test-engineer/agent.toml")),
        ("translator", include_str!("../../../agents/translator/agent.toml")),
        ("twitter-pipeline-runner", include_str!("../../../agents/twitter-pipeline-runner/agent.toml")),
